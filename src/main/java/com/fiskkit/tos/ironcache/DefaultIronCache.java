package com.fiskkit.tos.ironcache;
...
public class DefaultIronCache implements IronCache {
	...
	/**
	 * Mixin to add Jackson annotations to {@link com.github.mrcritical.ironcache.CacheItem}.
	 * 
	 * @author pjarrell
	 * 
	 */
	...
	/**
	 * Mixin to add Jackson annotations to {@link com.github.mrcritical.ironcache.Cache}.
	 * 
	 * @author pjarrell
	 * 
	 */
	...
	/**
	 * Deserialize a Joda {@link org.joda.time.LocalDateTime}.
	 *
	 * @author pjarrell
	 *
	 */
	...
	/**
	 * Serialize a Joda {@link org.joda.time.LocalDateTime}.
	 *
	 * @author pjarrell
	 *
	 */
	...
	/**
	 * Add mixins to the {@link com.fasterxml.jackson.databind.ObjectMapper} so Jackson can
	 * serialize/deserialize cache objects.
	 *
	 * @param json
	 *            is the {@link com.fasterxml.jackson.databind.ObjectMapper} to augment
	 */
	...
	/**
	 * Hidden constructor for configuring the default {@link com.fasterxml.jackson.databind.ObjectMapper} and
	 * {@link org.apache.http.client.HttpClient}. These can be overridden later using
	 * {@link #setJson(com.fasterxml.jackson.databind.ObjectMapper)} and {@link #setHttpClient(org.apache.http.client.HttpClient)}.
	 */
